...
_FORK_REPOSITORY = "NotLeonian/competitive-verifier"
_FORK_REPOSITORY_URL = f"https://github.com/{_FORK_REPOSITORY}"
_UPSTREAM_REPOSITORY = "competitive-verifier/competitive-verifier"
_UPSTREAM_REPOSITORY_URL = f"https://github.com/{_UPSTREAM_REPOSITORY}"
_GENERATOR_DESCRIPTION = (
    f"This documentation is automatically generated by {_FORK_REPOSITORY}"
)
_GENERATOR_DESCRIPTION_HTML = (
    "This documentation is automatically generated by "
    f'<a href="{_FORK_REPOSITORY_URL}">{_FORK_REPOSITORY}</a> '
    "(forked from "
    f'<a href="{_UPSTREAM_REPOSITORY_URL}">{_UPSTREAM_REPOSITORY}</a>)'
)
...
class ConfigYaml(BaseModel):
    ...
    basedir: RelativeDirectoryPath | None = None
    ...
    consolidate: SortedPathSet | None = None


def _load_user_render_config_yml(docs_dir: pathlib.Path) -> ConfigYaml | None:
