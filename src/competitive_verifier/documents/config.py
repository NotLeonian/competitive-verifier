...
DEFAULT_DOCS_GENERATOR_REPOSITORY = "NotLeonian/competitive-verifier"
DEFAULT_DOCS_GENERATOR_REPOSITORY_URL = (
    f"https://github.com/{DEFAULT_DOCS_GENERATOR_REPOSITORY}"
)
DEFAULT_DOCS_DESCRIPTION = (
    "<small>This documentation is automatically generated by "
    f'<a href="{DEFAULT_DOCS_GENERATOR_REPOSITORY_URL}">'
    f"{DEFAULT_DOCS_GENERATOR_REPOSITORY}</a></small>"
)
...
class ConfigYaml(BaseModel):
    ...
    description: str = DEFAULT_DOCS_DESCRIPTION
